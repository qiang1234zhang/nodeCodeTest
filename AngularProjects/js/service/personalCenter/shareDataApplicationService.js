define(['app'], function (app) {
    app.register.service('$shareDataApplicationService', ['$http', '$q', '$global_var', function ($http, $q, $global_var) {
        //保存申请
        this.createData = function (data) {
            var deferred = $q.defer();
            $http({
                method: 'POST',
                url: $global_var.base_url + "resource/proposeShareRestServer/share",
                data: data
